...
<LCURLY>
    ...
    <K_PROCEDURE>
         <IDENTIFIER,set_constant><LPAREN>
            <K_DOUBLE>  <IDENTIFIER,dval><COMMA>                   <COMMENT>
            <K_DOUBLE>  <IDENTIFIER,dsoln><LBRACKET><RBRACKET><COMMA> <K_INTEGER> <IDENTIFIER,s1>     <COMMENT>
                     <RPAREN>
    <LCURLY>
        <K_INTEGER> <IDENTIFIER,i> <ASSIGN> <ICONSTANT,0><SEMI>                     <COMMENT>
    ...
    <K_PROCEDURE>
         <IDENTIFIER,print_vector><LPAREN>
            <K_STRING>  <IDENTIFIER,title><COMMA>                  <COMMENT>
            <K_DOUBLE>  <IDENTIFIER,dsoln><LBRACKET><RBRACKET><COMMA> <K_INTEGER> <IDENTIFIER,s1>     <COMMENT>
                     <RPAREN>
    <LCURLY>
    ...
    <LCURLY>
        <K_INTEGER> <IDENTIFIER,i> <ASSIGN> <ICONSTANT,0><SEMI>                 <COMMENT>
        <K_DOUBLE>  <IDENTIFIER,asoln><SEMI>                  <COMMENT>
        <K_DOUBLE>  <IDENTIFIER,l0_norm> <ASSIGN> <DCONSTANT,0.0d0><SEMI>       <COMMENT>
    ...
    <K_PROCEDURE>
         <IDENTIFIER,residuals><LPAREN>
            <K_DOUBLE>  <IDENTIFIER,dsoln><LBRACKET><RBRACKET><COMMA> <K_INTEGER> <IDENTIFIER,s1><COMMA>        <COMMENT>
            <K_DOUBLE>  <IDENTIFIER,drhs><LBRACKET><RBRACKET><COMMA> <K_INTEGER> <IDENTIFIER,rhs1><COMMA>       <COMMENT>
            <K_DOUBLE>  <IDENTIFIER,dres><LBRACKET><RBRACKET><COMMA> <K_INTEGER> <IDENTIFIER,res1>        <COMMENT>
                   <RPAREN>
    <LCURLY>
        <K_INTEGER> <IDENTIFIER,i><SEMI>                      <COMMENT>
    ...
    <K_DOUBLE> <IDENTIFIER,gauss_seidel><LPAREN>
            <K_INTEGER> <IDENTIFIER,iters><COMMA>                      <COMMENT>
            <K_DOUBLE>  <IDENTIFIER,dsoln><LBRACKET><RBRACKET><COMMA> <K_INTEGER> <IDENTIFIER,s1><COMMA>        <COMMENT>
            <K_DOUBLE>  <IDENTIFIER,drhs><LBRACKET><RBRACKET><COMMA> <K_INTEGER> <IDENTIFIER,rhs1>        <COMMENT>
                     <RPAREN>
    <LCURLY>
        <K_INTEGER> <IDENTIFIER,i><COMMA> <IDENTIFIER,n><ASSIGN><ICONSTANT,1><SEMI>                        <COMMENT>
    ...
    <K_INTEGER> <IDENTIFIER,interpolate><LPAREN> 
            <K_DOUBLE> <IDENTIFIER,dfrom><LBRACKET><RBRACKET><COMMA> <K_INTEGER> <IDENTIFIER,f1><COMMA>         <COMMENT>
            <K_DOUBLE> <IDENTIFIER,dto><LBRACKET><RBRACKET><COMMA>   <K_INTEGER> <IDENTIFIER,t1>          <COMMENT>
                   <RPAREN>
    <LCURLY>
        ...
        <K_PROCEDURE>
             <IDENTIFIER,coarsen><LPAREN> 
                ...
                <K_DOUBLE> <IDENTIFIER,dto><LBRACKET><RBRACKET><COMMA>   <K_INTEGER> <IDENTIFIER,t1>      <COMMENT>
                   <RPAREN>
        <LCURLY>
            <K_INTEGER> <IDENTIFIER,i><COMMA> <IDENTIFIER,m><SEMI>       <COMMENT>
            ...
            <K_DO> <LPAREN> <IDENTIFIER,i> <ASSIGN> <ICONSTANT,1> <IDENTIFIER,i> <LT> <IDENTIFIER,t1> <IDENTIFIER,i><INCREMENT> <RPAREN>
            <LCURLY>
        ...
        <LCURLY>
            ...
            <COMMENT>
            <IDENTIFIER,m> <ASSIGN> <ICONSTANT,0><SEMI>
            <K_DO> <LPAREN> <IDENTIFIER,i> <ASSIGN> <ICONSTANT,1><SEMI> <IDENTIFIER,i> <LT> <IDENTIFIER,f1> <IDENTIFIER,i><INCREMENT> <RPAREN>
            <LCURLY>
    ...
    <K_INTEGER> <IDENTIFIER,main><LPAREN> 
            <RPAREN>
    <LCURLY>
        <K_INTEGER> <IDENTIFIER,rval> <ASSIGN> <ICONSTANT,0><SEMI>      <COMMENT>
        <K_INTEGER> <IDENTIFIER,fm1><ASSIGN><ICONSTANT,1><COMMA> <IDENTIFIER,cm1><SEMI>    <COMMENT>
        <K_DOUBLE>  <IDENTIFIER,enorm><SEMI>          <COMMENT>
        ...
        <COMMENT>
        <K_DOUBLE> <IDENTIFIER,fm><LBRACKET><IDENTIFIER,fm1><PLUS><ICONSTANT,1><RBRACKET><COMMA>       <COMMENT>
               <IDENTIFIER,frhs><LBRACKET><IDENTIFIER,fm1><PLUS><ICONSTANT,1><RBRACKET><COMMA>     <COMMENT>
               <IDENTIFIER,fres><LBRACKET><IDENTIFIER,fm1><PLUS><ICONSTANT,1><RBRACKET><SEMI>     <COMMENT>
        <K_DOUBLE> <IDENTIFIER,cm><LBRACKET><IDENTIFIER,cm1><PLUS><ICONSTANT,1><RBRACKET><COMMA> <IDENTIFIER,crhs><LBRACKET><IDENTIFIER,cm1><PLUS><ICONSTANT,1><RBRACKET><SEMI>  <COMMENT>
                                        <COMMENT>
