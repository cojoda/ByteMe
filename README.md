...
Once built, you can run the lexer and parser on example files located in the `examples/` directory. For example, to process the `brain.f24` file and display the output, use the following command:
...
- **GCC and Flex/Bison** from Pop!_OS.
